...
class GCNWithEdges_Player(nn.Module):
    def __init__(self, dim_in, dim_out, dropout, residual, ffn, act=None):
        super().__init__()
        self.dim_in = dim_in
        ...
        activation=activation_resolver(act)
